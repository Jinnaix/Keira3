...
export enum SAI_EVENTS {
  ...
  //NEAR_PLAYERS = 101, AC Only
  //NEAR_PLAYERS_NEGATION = 102, AC only
}
...
SAI_EVENT_PARAM1_NAMES[SAI_EVENTS.EVENT_PHASE_CHANGE] = 'event phase mask';
SAI_EVENT_PARAM1_TOOLTIPS[SAI_EVENTS.EVENT_PHASE_CHANGE] = 'Phasemask ID';
...
SAI_EVENT_TOOLTIPS[SAI_EVENTS.SUMMONED_UNIT_DIES] = 'SUMMONED_UNIT_DIES';
SAI_EVENT_PARAM1_NAMES[SAI_EVENTS.SUMMONED_UNIT_DIES] = 'CreatureID (0=all)';
