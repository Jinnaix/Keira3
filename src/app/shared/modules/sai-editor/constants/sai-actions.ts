...
// SMART_ACTION_ATTACK_STOP - is Move_forward in AC
SAI_ACTION_TOOLTIPS[SAI_ACTIONS.ATTACK_STOP] = 'Stops current attack';
...
SAI_ACTION_TOOLTIPS[SAI_ACTIONS.SET_DISABLE_GRAVITY] = 'Sets flying flag on or off.';
SAI_ACTION_PARAM1_NAMES[SAI_ACTIONS.SET_DISABLE_GRAVITY] = SAI_ACTION_PARAM1_NAMES[SAI_ACTIONS.SET_RUN];
SAI_ACTION_PARAM1_TOOLTIPS[SAI_ACTIONS.SET_DISABLE_GRAVITY] = SAI_ACTION_PARAM1_TOOLTIPS[SAI_ACTIONS.SET_RUN];
...
SAI_ACTION_TOOLTIPS[SAI_ACTIONS.ENABLE_TEMP_GOBJ] = 'Temporary gameobject.';
SAI_ACTION_PARAM1_NAMES[SAI_ACTIONS.ENABLE_TEMP_GOBJ] = 'Alivetime in SECONDS';
SAI_ACTION_PARAM1_TOOLTIPS[SAI_ACTIONS.ENABLE_TEMP_GOBJ] = 'Alivetime in SECONDS';
...
SAI_ACTION_TOOLTIPS[SAI_ACTIONS.SELF_CAST] = 'Make our action invoker type cast a spell to our target type';
SAI_ACTION_PARAM1_NAMES[SAI_ACTIONS.SELF_CAST] = 'SpellId';
SAI_ACTION_PARAM2_NAMES[SAI_ACTIONS.SELF_CAST] = 'CastFlags';
SAI_ACTION_PARAM3_NAMES[SAI_ACTIONS.SELF_CAST] = 'TriggeredFlags';
...
SAI_ACTION_TOOLTIPS[SAI_ACTIONS.MOVE_OFFSET] = 'Move to destination';
...
SAI_ACTION_TOOLTIPS[SAI_ACTIONS.SET_CORPSE_DELAY] = 'Quicker respawn?';

// SMART_ACTION_DISABLE_EVADE
SAI_ACTION_TOOLTIPS[SAI_ACTIONS.DISABLE_EVADE] = 'Disable creature evade';
SAI_ACTION_PARAM1_NAMES[SAI_ACTIONS.DISABLE_EVADE] = '1/0';
SAI_ACTION_PARAM1_TOOLTIPS[SAI_ACTIONS.DISABLE_EVADE] = '1=Disable, 0=re-enalbe';

// SMART_ACTION_GO_SET_GO_STATE
SAI_ACTION_TOOLTIPS[SAI_ACTIONS.GO_SET_GO_STATE] = 'Set GOB State';
SAI_ACTION_PARAM1_NAMES[SAI_ACTIONS.GO_SET_GO_STATE] = 'state';

// SMART_ACTION_SET_CAN_FLY
SAI_ACTION_TOOLTIPS[SAI_ACTIONS.SET_CAN_FLY] = 'Set can fly';
SAI_ACTION_PARAM1_NAMES[SAI_ACTIONS.SET_CAN_FLY] = '0/1';

// SMART_ACTION_REMOVE_AURAS_BY_TYPE
SAI_ACTION_TOOLTIPS[SAI_ACTIONS.REMOVE_AURAS_BY_TYPE] = 'Remove auras by tpe';
SAI_ACTION_PARAM1_NAMES[SAI_ACTIONS.REMOVE_AURAS_BY_TYPE] = 'type';
...
SAI_ACTION_TOOLTIPS[SAI_ACTIONS.PAUSE_MOVEMENT] = 'default= Waypoint, random etc - active=point movement - controlled=mindcontrole etc';
SAI_ACTION_PARAM1_NAMES[SAI_ACTIONS.PAUSE_MOVEMENT] = 'movementslot (def=0, act=1, cont=2)';
SAI_ACTION_PARAM2_NAMES[SAI_ACTIONS.PAUSE_MOVEMENT] = 'pausetime (ms)';
SAI_ACTION_PARAM3_NAMES[SAI_ACTIONS.PAUSE_MOVEMENT] = 'forced';
SAI_ACTION_PARAM3_TOOLTIPS[SAI_ACTIONS.PAUSE_MOVEMENT] = 'depends on the movement generator. some will stop automatically, other will let the current spline finish first';

// SMART_ACTION_SPAWN_SPAWNGROUP
SAI_ACTION_TOOLTIPS[SAI_ACTIONS.SPAWN_SPAWNGROUP] = 'Spawn Spawngroup';
SAI_ACTION_PARAM1_NAMES[SAI_ACTIONS.SPAWN_SPAWNGROUP] = 'groupID';
SAI_ACTION_PARAM2_NAMES[SAI_ACTIONS.SPAWN_SPAWNGROUP] = 'min delay';
SAI_ACTION_PARAM3_NAMES[SAI_ACTIONS.SPAWN_SPAWNGROUP] = 'max delay';
SAI_ACTION_PARAM4_NAMES[SAI_ACTIONS.SPAWN_SPAWNGROUP] = 'spawnflags';

// SMART_ACTION_DESPAWN_SPAWNGROUP
SAI_ACTION_TOOLTIPS[SAI_ACTIONS.DESPAWN_SPAWNGROUP] = 'Despawn Spawngroup';
SAI_ACTION_PARAM1_NAMES[SAI_ACTIONS.DESPAWN_SPAWNGROUP] = 'groupID';
SAI_ACTION_PARAM2_NAMES[SAI_ACTIONS.DESPAWN_SPAWNGROUP] = 'min delay';
SAI_ACTION_PARAM3_NAMES[SAI_ACTIONS.DESPAWN_SPAWNGROUP] = 'max delay';
SAI_ACTION_PARAM4_NAMES[SAI_ACTIONS.DESPAWN_SPAWNGROUP] = 'spawnflags';

// SMART_ACTION_RESPAWN_BY_SPAWNID
SAI_ACTION_TOOLTIPS[SAI_ACTIONS.RESPAWN_BY_SPAWNID] = 'respawn by spawnID';
SAI_ACTION_PARAM1_NAMES[SAI_ACTIONS.RESPAWN_BY_SPAWNID] = 'SpawnType';
SAI_ACTION_PARAM2_NAMES[SAI_ACTIONS.RESPAWN_BY_SPAWNID] = 'SpawnID';
SAI_ACTION_PARAM1_TOOLTIPS[SAI_ACTIONS.RESPAWN_BY_SPAWNID] = '0 = Npc, 1 = Gob';
SAI_ACTION_PARAM2_TOOLTIPS[SAI_ACTIONS.RESPAWN_BY_SPAWNID] = 'Datanase Giud';

// SMART_ACTION_INVOKER_CAST
SAI_ACTION_TOOLTIPS[SAI_ACTIONS.INVOKER_CAST] = 'if avaliable, last used invoker will cast spellId with castFlags on targets';
...
//SAI_ACTION_TOOLTIPS[SAI_ACTIONS.SET_MOVEMENT_SPEED] = '';
...
SAI_ACTION_TOOLTIPS[SAI_ACTIONS.OVERRIDE_LIGHT] = 'Overwrites Light (day/night)';
SAI_ACTION_PARAM1_NAMES[SAI_ACTIONS.OVERRIDE_LIGHT] = 'zoneId';
SAI_ACTION_PARAM2_NAMES[SAI_ACTIONS.OVERRIDE_LIGHT] = 'areaLightId';
SAI_ACTION_PARAM3_NAMES[SAI_ACTIONS.OVERRIDE_LIGHT] = 'lightId';
SAI_ACTION_PARAM4_NAMES[SAI_ACTIONS.OVERRIDE_LIGHT] = 'fadeInTime';
SAI_ACTION_PARAM3_TOOLTIPS[SAI_ACTIONS.OVERRIDE_LIGHT] = 'Override Light ID';
SAI_ACTION_PARAM4_TOOLTIPS[SAI_ACTIONS.OVERRIDE_LIGHT] = 'transition Milliseconds';

// SMART_ACTION_OVERRIDE_WEATHER
SAI_ACTION_TOOLTIPS[SAI_ACTIONS.OVERRIDE_WEATHER] = 'Overwrites Weather';
SAI_ACTION_PARAM1_NAMES[SAI_ACTIONS.OVERRIDE_WEATHER] = 'zoneId';
SAI_ACTION_PARAM2_NAMES[SAI_ACTIONS.OVERRIDE_WEATHER] = 'weatherId';
SAI_ACTION_PARAM3_NAMES[SAI_ACTIONS.OVERRIDE_WEATHER] = 'weatherGrade (intensity)';
