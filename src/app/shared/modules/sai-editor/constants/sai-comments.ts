...
SAI_EVENT_COMMENTS[SAI_EVENTS.WAYPOINT_REACHED] = `On Waypoint _eventParamOne_ Reached`;
...
SAI_EVENT_COMMENTS[SAI_EVENTS.WAYPOINT_START] = `On Waypoint Started`;
...
SAI_EVENT_COMMENTS[SAI_EVENTS.WAYPOINT_PAUSED] = `On Waypoint Paused`;
SAI_EVENT_COMMENTS[SAI_EVENTS.WAYPOINT_RESUMED] = `On Waypoint Resumed`;
SAI_EVENT_COMMENTS[SAI_EVENTS.WAYPOINT_STOPPED] = `On Waypoint Stopped`;
SAI_EVENT_COMMENTS[SAI_EVENTS.WAYPOINT_ENDED] = `On Waypoint Finished`;
