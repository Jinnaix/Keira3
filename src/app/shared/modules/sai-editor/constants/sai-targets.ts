...
SAI_TARGET_TOOLTIPS[SAI_TARGETS.LOOT_RECIPIENTS] = 'All tagging players';
...
SAI_TARGET_TOOLTIPS[SAI_TARGETS.VEHICLE_ACCESSORY] = 'Vehicle can target unit in given seat';
SAI_TARGET_PARAM1_NAMES[SAI_TARGETS.VEHICLE_ACCESSORY] = 'Seat';

// SMART_TARGET_CLOSEST_UNSPAWNED_GAMEOBJECT
SAI_TARGET_TOOLTIPS[SAI_TARGETS.CLOSEST_UNSPAWNED_GAMEOBJECT] = 'Closest unspawned object with specified ID within specified range. (to be used only with action 70 and gameobjects with negative respawn time in the DB)';
SAI_TARGET_PARAM1_NAMES[SAI_TARGETS.CLOSEST_UNSPAWNED_GAMEOBJECT] = 'GO Entry';
SAI_TARGET_PARAM2_NAMES[SAI_TARGETS.CLOSEST_UNSPAWNED_GAMEOBJECT] = 'maxDist';
SAI_TARGET_PARAM1_TOOLTIPS[SAI_TARGETS.CLOSEST_UNSPAWNED_GAMEOBJECT] = '0 = any';
SAI_TARGET_PARAM2_TOOLTIPS[SAI_TARGETS.CLOSEST_UNSPAWNED_GAMEOBJECT] = 'Can be from 0-100 yards';
